...
if __name__ == "__main__":
    ...
    for _, row in tqdm(aggregated_df.iterrows(), total=len(aggregated_df)):
        vectors = text_to_vectors(row['aggregated_english_text'], ft_en_model, MAX_SEQUENCE_LENGTH)
    ...
    for _, row in tqdm(aggregated_df.iterrows(), total=len(aggregated_df)):
        vectors = text_to_vectors(row['aggregated_spanish_text'], ft_es_model, MAX_SEQUENCE_LENGTH)
